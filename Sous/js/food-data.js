...
const FOODS=[
  ...
  {name:'Milk',            w:100,kcal:46, p:3.4, c:5,   f:1.6, fi:0,   icon:'ti-glass',      kw:['milk','semi skimmed milk','semi-skimmed milk']},
  {name:'Whole milk',      w:100,kcal:61, p:3.2, c:4.8, f:3.3, fi:0,   icon:'ti-glass',      kw:['whole milk','full fat milk']},
  {name:'Oat milk',        w:100,kcal:45, p:1,   c:6.6, f:1.5, fi:0.8, icon:'ti-glass',      kw:['oat milk']},
  {name:'Almond milk',     w:100,kcal:13, p:0.5, c:0.7, f:1,   fi:0.2, icon:'ti-glass',      kw:['almond milk']},
  ...
  {name:'Whipping cream',  w:100,kcal:345,p:2,   c:3.5, f:36,  fi:0,   icon:'ti-glass',      kw:['whipping cream','double cream','heavy cream']},
  // Grains
  ...
  // Oils & fats
  {name:'Olive oil',       w:14, kcal:119,p:0,   c:0,   f:14,  fi:0,   icon:'ti-droplet',    kw:['olive oil','extra virgin olive oil','evoo']},
  {name:'Coconut oil',     w:14, kcal:121,p:0,   c:0,   f:14,  fi:0,   icon:'ti-droplet',    kw:['coconut oil']},
  {name:'Vegetable oil',   w:14, kcal:124,p:0,   c:0,   f:14,  fi:0,   icon:'ti-droplet',    kw:['vegetable oil','sunflower oil','rapeseed oil']},
  // Condiments & sauces
  ...
  {name:'Soy sauce',       w:15, kcal:8,  p:1.3, c:0.8, f:0,   fi:0,   icon:'ti-droplet',    kw:['soy sauce','soya sauce','tamari']},
