...
const FOODS=[
  ...
  {name:'Cheddar',         w:30, kcal:121,p:7,   c:0.2, f:10,  fi:0,   icon:'ti-cheese',     kw:['cheddar','cheese','cheddar cheese'],defaultUnit:'slice',units:[{label:'slice',grams:25},{label:'matchbox',grams:30},{label:'g',grams:1}]},
  ...
  {name:'Pineapple',       w:100,kcal:50, p:0.5, c:13,  f:0.1, fi:1.4, icon:'ti-apple',      kw:['pineapple'],defaultUnit:'cup',units:[{label:'cup',grams:165},{label:'g',grams:1}]},
